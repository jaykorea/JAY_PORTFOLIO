"""
Django settings for jay_pt project.
...
WSGI_APPLICATION = 'jay_pt.wsgi.application'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR_PATH, 'build', 'static')]
STATIC_ROOT = os.path.join(BASE_DIR_PATH, 'staticfiles')
